...
class XmlFileLoaderTest extends TestCase
{
    ...
    {
        $loader = new XmlFileLoader(DIR_DOMPDF.'/constraint-mapping.xml');
    ...
    {
        $loader = new XmlFileLoader(DIR_DOMPDF.'/constraint-mapping-non-strings.xml');
        $metadata = new ClassMetadata('Symfony\Component\Validator\Tests\Fixtures\Entity');
    ...
    {
        $loader = new XmlFileLoader(DIR_DOMPDF.'/withdoctype.xml');
        $metadata = new ClassMetadata('Symfony\Component\Validator\Tests\Fixtures\Entity');
