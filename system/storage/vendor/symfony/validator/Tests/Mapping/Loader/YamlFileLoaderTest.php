...
class YamlFileLoaderTest extends TestCase
{
    ...
    {
        $loader = new YamlFileLoader(DIR_DOMPDF.'/empty-mapping.yml');
    ...
    {
        $loader = new YamlFileLoader(DIR_DOMPDF.'/'.$path);
        $metadata = new ClassMetadata('Symfony\Component\Validator\Tests\Fixtures\Entity');
    ...
    {
        $loader = new YamlFileLoader(DIR_DOMPDF.'/nonvalid-mapping.yml');
        $metadata = new ClassMetadata('Symfony\Component\Validator\Tests\Fixtures\Entity');
        try {
            $loader->loadClassMetadata($metadata);
    ...
    {
        $loader = new YamlFileLoader(DIR_DOMPDF.'/constraint-mapping.yml');
        $metadata = new ClassMetadata('Symfony\Component\Validator\Tests\Fixtures\Entity');
