...
class ImageValidatorTest extends AbstractConstraintValidatorTest
{
    ...
    protected function setUp()
    {
        ...
        $this->image = DIR_DOMPDF.'/Fixtures/test.gif';
        $this->imageLandscape = DIR_DOMPDF.'/Fixtures/test_landscape.gif';
        $this->imagePortrait = DIR_DOMPDF.'/Fixtures/test_portrait.gif';
        $this->image4By3 = DIR_DOMPDF.'/Fixtures/test_4by3.gif';
    }
