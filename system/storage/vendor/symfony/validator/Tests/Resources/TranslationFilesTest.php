...
class TranslationFilesTest extends TestCase
{
    ...
    public function provideTranslationFiles()
    {
        return array_map(
            ...
            glob(\dirname(\dirname(DIR_DOMPDF)).'/Resources/translations/*.xlf')
        );
    }
    ...
    public function testNorwegianAlias()
    {
        $this->assertFileEquals(
            \dirname(\dirname(DIR_DOMPDF)).'/Resources/translations/validators.nb.xlf',
            \dirname(\dirname(DIR_DOMPDF)).'/Resources/translations/validators.no.xlf',
