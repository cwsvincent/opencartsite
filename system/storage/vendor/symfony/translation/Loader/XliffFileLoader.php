...
class XliffFileLoader implements LoaderInterface
{
    ...
    {
        if ('1.2' === $xliffVersion) {
            $schemaSource = file_get_contents(DIR_DOMPDF.'/schema/dic/xliff-core/xliff-core-1.2-strict.xsd');
            $xmlUri = 'http://www.w3.org/2001/xml.xsd';
        } elseif ('2.0' === $xliffVersion) {
            $schemaSource = file_get_contents(DIR_DOMPDF.'/schema/dic/xliff-core/xliff-core-2.0.xsd');
    ...
    {
        $newPath = str_replace('\\', '/', DIR_DOMPDF).'/schema/dic/xliff-core/xml.xsd';
