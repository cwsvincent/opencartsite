...
class TranslatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testTransWithoutFallbackLocaleFile($format, $loader)
    {
        ...
        $translator->addResource($format, DIR_DOMPDF.'/fixtures/non-existing', 'en');
        $translator->addResource($format, DIR_DOMPDF.'/fixtures/resources.'.$format, 'en');
    ...
    public function testTransWithFallbackLocaleFile($format, $loader)
    {
        ...
        $translator->addLoader($format, new $loaderClass());
        $translator->addResource($format, DIR_DOMPDF.'/fixtures/non-existing', 'en_GB');
        $translator->addResource($format, DIR_DOMPDF.'/fixtures/resources.'.$format, 'en', 'resources');
    ...
    public function testFallbackCatalogueResources()
    {
        ...
        $translator->addResource('yml', DIR_DOMPDF.'/fixtures/empty.yml', 'en_GB');
        $translator->addResource('yml', DIR_DOMPDF.'/fixtures/resources.yml', 'en');
        ...
        $this->assertContains(DIR_DOMPDF.DIRECTORY_SEPARATOR.'fixtures'.DIRECTORY_SEPARATOR.'resources.yml', $resources);

        $resources = $translator->getCatalogue('en_GB')->getResources();
        $this->assertCount(2, $resources);
        $this->assertContains(DIR_DOMPDF.DIRECTORY_SEPARATOR.'fixtures'.DIRECTORY_SEPARATOR.'empty.yml', $resources);
        $this->assertContains(DIR_DOMPDF.DIRECTORY_SEPARATOR.'fixtures'.DIRECTORY_SEPARATOR.'resources.yml', $resources);
    }
