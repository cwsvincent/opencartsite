...
class MoFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    public function testLoad()
    {
        ...
        $resource = DIR_DOMPDF.'/../fixtures/resources.mo';
    ...
    {
        $loader = new MoFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/plurals.mo';
        $catalogue = $loader->load($resource, 'en', 'domain1');
    ...
    {
        $loader = new MoFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/non-existing.mo';
    ...
    {
        $loader = new MoFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/empty.mo';
        $loader->load($resource, 'en', 'domain1');
    }
    ...
    {
        $loader = new MoFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/empty-translation.mo';
