...
class IcuDatFileLoaderTest extends LocalizedTestCase
{
    ...
    public function testLoadInvalidResource()
    {
        ...
        $loader->load(DIR_DOMPDF.'/../fixtures/resourcebundle/corrupted/resources', 'es', 'domain2');
    }
    ...
    public function testDatEnglishLoad()
    {
        ...
        $loader = new IcuDatFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/resourcebundle/dat/resources';
    ...
    {
        $loader = new IcuDatFileLoader();
        $loader->load(DIR_DOMPDF.'/../fixtures/non-existing.txt', 'en', 'domain1');
    }
}
