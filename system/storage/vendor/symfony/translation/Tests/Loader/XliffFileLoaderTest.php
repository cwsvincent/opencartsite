...
class XliffFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    public function testLoad()
    {
        ...
        $resource = DIR_DOMPDF.'/../fixtures/resources.xlf';
    ...
    {
        $loader = new XliffFileLoader();
        $catalogue = $loader->load(DIR_DOMPDF.'/../fixtures/resname.xlf', 'en', 'domain1');
    ...
    {
        $loader = new XliffFileLoader();
        $catalogue = $loader->load(DIR_DOMPDF.'/../fixtures/resources.xlf', 'en', 'domain1');
    ...
    {
        $loader = new XliffFileLoader();
        $catalogue = $loader->load(DIR_DOMPDF.'/../fixtures/encoding.xlf', 'en', 'domain1');
    ...
    {
        $loader = new XliffFileLoader();
        $catalogue = $loader->load(DIR_DOMPDF.'/../fixtures/with-attributes.xlf', 'en', 'domain1');
    ...
    {
        $loader = new XliffFileLoader();
        $loader->load(DIR_DOMPDF.'/../fixtures/resources.php', 'en', 'domain1');
    }
    ...
    {
        $loader = new XliffFileLoader();
        $loader->load(DIR_DOMPDF.'/../fixtures/non-valid.xlf', 'en', 'domain1');
    }
    ...
    {
        $loader = new XliffFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/non-existing.xlf';
    ...
    {
        $loader = new XliffFileLoader();
        $loader->load(DIR_DOMPDF.'/../fixtures/withdoctype.xlf', 'en', 'domain1');
    }

    public function testParseEmptyFile()
    {
        $loader = new XliffFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/empty.xlf';
    ...
    {
        $loader = new XliffFileLoader();
        $catalogue = $loader->load(DIR_DOMPDF.'/../fixtures/withnote.xlf', 'en', 'domain1');
    ...
    {
        $loader = new XliffFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/resources-2.0.xlf';
        $catalogue = $loader->load($resource, 'en', 'domain1');
