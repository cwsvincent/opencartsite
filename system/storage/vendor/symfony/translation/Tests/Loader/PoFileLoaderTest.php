...
class PoFileLoaderTest extends \PHPUnit_Framework_TestCase
{
    public function testLoad()
    {
        ...
        $resource = DIR_DOMPDF.'/../fixtures/resources.po';
    ...
    {
        $loader = new PoFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/plurals.po';
        $catalogue = $loader->load($resource, 'en', 'domain1');
    ...
    {
        $loader = new PoFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/empty.po';
        $catalogue = $loader->load($resource, 'en', 'domain1');
    ...
    {
        $loader = new PoFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/non-existing.po';
    ...
    {
        $loader = new PoFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/empty-translation.po';
        $catalogue = $loader->load($resource, 'en', 'domain1');
    ...
    {
        $loader = new PoFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/escaped-id.po';
        $catalogue = $loader->load($resource, 'en', 'domain1');
    ...
    {
        $loader = new PoFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/escaped-id-plurals.po';
        $catalogue = $loader->load($resource, 'en', 'domain1');
    ...
    {
        $loader = new PoFileLoader();
        $resource = DIR_DOMPDF.'/../fixtures/fuzzy-translations.po';
        $catalogue = $loader->load($resource, 'en', 'domain1');
